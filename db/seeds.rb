...
protocols = [
  ...
  },
  {
    ...
    name_ar: "90-Day Glow Reset", name_en: "90-Day Glow Reset",
    promise_ar: "اثنا عشر أسبوعاً لبشرةٍ تبدو وكأنها استعادت حيويتها — دون تصنّع.",
    promise_en: "Twelve weeks to skin that looks rested — not redone.",
  ...
  },
  {
    ...
    name_ar: "Bride's 180", name_en: "Bride's 180",
    promise_ar: "حسّني بشرتكِ في ستة أشهر — بخطةٍ طبيةٍ مُحكمة.",
    promise_en: "Your skin glowing in six months — planned by a doctor.",
  ...
  },
  {
    ...
    name_ar: "Reset Crown", name_en: "Reset Crown",
    promise_ar: "لشعرٍ يفقدُ كثافته أكثر مما ينبغي.",
    promise_en: "For hair that's shedding faster than it should.",
  ...
  },
  {
    ...
    name_ar: "8-Week Sculpt", name_en: "8-Week Sculpt",
    promise_ar: "ثمانية أسابيع لنحت القوام، وتعزيز القوة، وتصحيح استقامة الجسم.",
    promise_en: "Eight weeks for tone, strength, and posture.",
  ...
  },
  {
    ...
    name_ar: "Skin Insider Membership", name_en: "Skin Insider Membership",
    promise_ar: "لأنكِ تطمحين لبشرةٍ تدومُ نضارتها لسنوات.",
    promise_en: "For skin you intend to keep for years.",
