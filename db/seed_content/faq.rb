  ...
  },
  {
    ...
    contents: [
      ...
      { key: "q_2_answer", label: "Q2 answer", content_type: "richtext",
        en: "Send a private inquiry — on WhatsApp or through the form. Our medical team or patient relations lead reviews every message personally.",
        ar: "" },
      ...
      { key: "q_5_question", label: "Q5 question",
        en: "Who will conduct my assessment?", ar: "" },
      { key: "q_5_answer", label: "Q5 answer", content_type: "richtext",
        en: "Your initial assessment is conducted personally by our medical director. Ongoing care may involve the wider medical team, always under their direction.",
        ar: "" },
      ...
      { key: "q_7_answer", label: "Q7 answer", content_type: "richtext",
        en: "Your inquiry is seen only by our patient relations lead and your treating doctor. We are PDPL compliant and store data securely.",
        ar: "" },
