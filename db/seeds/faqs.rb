...
FAQ_SEEDS = [
  ...
  { category: "before_you_come_in", position: 2,
    ...
    answer_en: "Send a private inquiry — on WhatsApp or through the form. Our medical team or patient relations lead reviews every message personally.",
    answer_ar: "أرسلي استفسارًا خاصًا — عبر واتساب أو من خلال النموذج. يُراجع فريقنا الطبي أو مسؤولة علاقات المريضات كل رسالة شخصيًا." },
  ...
  { category: "how_care_works", position: 2,
    question_en: "Who will conduct my assessment?", question_ar: "من سيُجري تقييمي الأول؟",
    answer_en: "Your initial assessment is conducted personally by our medical director. Ongoing care may involve the wider medical team, always under their direction.",
    answer_ar: "تقييمك الأول تُجريه مديرتنا الطبية شخصيًا. وقد تشمل الرعاية اللاحقة الفريق الطبي الأوسع، دائمًا تحت إشرافها." },
  ...
  { category: "privacy", position: 1,
    ...
    answer_en: "Your inquiry is seen only by our patient relations lead and your treating doctor. We are PDPL compliant and store data securely.",
    answer_ar: "لا يطّلع على استفسارك سوى مسؤولة علاقات المريضات وطبيبتك المعالجة. نلتزم بنظام حماية البيانات الشخصية (PDPL) ونحفظ بياناتك بأمان." },
